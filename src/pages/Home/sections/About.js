      ...
      <div className="grid md:grid-cols-2 items-center gap-8 mx-auto max-w-5xl">
        <div className="slide_l">
          ...
          <div className=" flex flex-wrap md:justify-start justify-center gap-4">
            <a href="#vet">
              <div className="slide_u rounded-lg px-4 py-4 max-w-[130px] flex items-center border-2 hover:bg-orange-400 hover:text-white transition-all border-orange-400 ">
                <div>
            ...
            <a href="#store">
              <div className="slide_u rounded-lg px-4 py-4 max-w-[130px] flex items-center border-2 hover:bg-Green hover:text-white transition-all border-Green ">
                <div>
            ...
            <div className="slide_u rounded-lg px-4 py-4 max-w-[130px] flex items-center border-2 hover:bg-gray-200 transition-all border-gray-200 ">
              <div>
                <span className="block text-Green font-semibold">Our</span>
                <h2 className="text-lg">
        ...
        <div className="slide_l w-full aspect-square flex items-center relative">
